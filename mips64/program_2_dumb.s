...
;-----------
    .text;
        ...
        daddi R2,R0,0  ;R2 contains current offset (i) inside the vector
...
LOOP:   mul.d F23, F11, F12 ; v3[i] = v1[i]*v2[i];
        ...
        l.d F12, v2(R2)     ; load from memory v2[i]
        l.d F11, v1(R2)     ; load from memory v1[i]
