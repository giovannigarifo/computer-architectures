...
Reset_Handler   PROC
				...
				; now in the LSB of r15
				; we have the EOR of all the bits

				ldr		r6, =0x00000001 ; mask to extract the lsb (doing AND)
				ands	r7, r5, r6	; extract lsb of r5 in r7, if it's 1 = odd parity

				ldrne	r1, =0x11111111	; odd parity
				ldreq	r1, =0x00000000	; even parirty
